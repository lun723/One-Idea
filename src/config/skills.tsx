...
export const skillsConfig: Record<string, SkillConfig> = {
    'React.js': { 
        icon: <React />, 
        displayText: 'React.js Framework' 
    },
    'Vite': { 
        icon: <ViteJS />, 
        displayText: 'Vite Build Tool' 
    },
    'MUI': { 
        icon: <MaterialUI />, 
        displayText: 'Material-UI Library' 
    },
    'Bootstrap': { 
        icon: <Bootstrap5 />, 
        displayText: 'Bootstrap CSS Framework' 
    },
    'Ant Design': { 
        icon: (
    ...
    'RWD響應式網頁設計': { 
        ...
        displayText: 'Responsive Web Design' 
    },
    'SCSS/SASS': { 
        icon: <Sass />, 
        displayText: 'SCSS/SASS Styling' 
    },
    'Git': { 
        icon: <Git />, 
        displayText: 'Git Version Control' 
    },
    'Github': { 
        icon: <GitHubLight />, 
    ...
    'Node.js': { 
        icon: <NodeJs />, 
        displayText: 'Node.js Runtime' 
    },
    'Canva': { 
        icon: <Canva />, 
        displayText: 'Canva Design Tool' 
    },
};
